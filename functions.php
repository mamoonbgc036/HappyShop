...
function ecom_subcategory_count_html( $markup ){
	if ( get_theme_mod( 'category_prod_num_switch' ) != '1' ){
		return '';
	}
	return $markup;
}

add_action( 'woocommerce_subcategory_count_html', 'ecom_subcategory_count_html' );
